    ...
    return (
            ...
            <Content>
                <Row
                    ...
                    <Card title="Sistema de Cadastro de Voos" style={{ width: "25vw", padding: 15 }}>
                        <Col>
                            <div>
                                <p>Adicione os dados do voo.</p>
                            </div>
                        </Col>
                        
                        <Form.Item name="cod"
                            rules={[
                                { required: true, message: "É necessário um código para o voo" },
                                {
                                    type: "number",
                                    min: 3,
                            ...
                            <Input placeholder="Insira o código do voo" size="large" allowClear prefix={<BarcodeOutlined />} />
                        </Form.Item>
                        
                            <Form.Item name="origem"
                                style={{display: 'inline-block', width: 'calc(50% - 8px)', margin: '0 8px'}}
                                rules={[
                                    { required: true, message: "Insira um local" },
                                    {
                                        type: "string",
                                        min: 4,
                                        message: 'O local precisa ter mais do que 04 caracteres'
                                    }
                                ]}>
                                <span style={{ fontWeight: 'bold' }}>Origem:</span>
                                <Input placeholder="Origem" size="large" allowClear prefix={<UserOutlined />} />
                            </Form.Item>
                            <Form.Item name="destino"
                                ...
                                <Input placeholder="Destino" size="large" allowClear prefix={<UserOutlined />} />
                            </Form.Item>
                        ...
                        <Form.Item name="assentos">
                            <span style={{ fontWeight: 'bold' }}>Assentos totais:</span>
                            <Input placeholder="Assentos" size="large" allowClear />
                        </Form.Item>
                        <Form.Item name="voo">

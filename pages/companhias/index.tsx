        ...
        <Content>
            <Row justify="space-around"
                ...
                <Card style={{ width: "25vw", padding: 15 }}>
                    <div>
                        <h2 style={{ color: '#2D4040', fontWeight: "bold", paddingTop: 45 }}>Cadastro de companhia:</h2>
                        <p>Preencha as informações da companhia.</p>
                    </div>
                    <Divider />
                    <Form>
                        <Form.Item name="cod" rules={[
                            { required: true, message: "Por favor, insira a companhia!" },
                            {
                                type: "string",
                                min: 3,
                                message: "Por favor, insira um código para a companhia"
                            }
                        ]}>
